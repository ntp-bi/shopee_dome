...
<head>
    ...
    <title><?=$title?></title>
    <link rel="icon" href="https://i0.wp.com/indobubbletea.blog/wp-content/uploads/2019/07/Icon-Shopee.png?fit=300%2C300&ssl=1">
                ...
                <nav class="header__navbar hide-on-mobile-tablet">
                        ...
                        <li class="header__navbar-item header__navbar-item--has-qr header__navbar-item--separate">
                            ...
                            <div class="header__qr">
                                ...
                                <div class="header__qr-apps">
                                    ...
                                    <a href="" class="header__qr-link">
                                        <img src="./assets/img/apstore.png" alt="Google Play" class="header__qr-download-img">
                                    </a>
                                </div>
                            </div>
                        </li>
                    ...
                    <ul class="header__navbar-list">
                                    ...
                                    <li class="header__notify-item header__notify-item--viewed">
                                        <a href="" class="header__notify-link">
                                            ...
                                            <div class="header__notify-info">
                                                <span class="header__notify-name">Chấn động! Deal 1K nhưng được bao ship</span>
                                                <span class="header__notify-descriotion">⭐ Thứ 6 gì cũng rẻ chỉ từ 1K🏠 Decor nhà cửa, làm đẹp, phụ kiện 💝 Ngàn deal đồng giá 1K, 9K 🛒 Freeship đơn từ 0Đ - Mua ngay!</span>
                                            </div>
                                        </a>
                                    </li>
                                    <li class="header__notify-item header__notify-item--viewed">
                                        <a href="" class="header__notify-link">
                                            ...
                                            <div class="header__notify-info">
                                                ...
                                                <span class="header__notify-descriotion">🚛 Cơ hội cuối lưu mã Freeship🌟 Lượt
                                    ...
                                    <li class="header__notify-item">
                                        <a href="" class="header__notify-link">
                                            ...
                                            <div class="header__notify-info">
                                                ...
                                                <span class="header__notify-descriotion">👉 Cho đơn từ 0đ - Mã có sẵn trong ví! 🤑 Siêu giảm giá, sale linh đình ️🛒 Dùng ngay thôi!</span>
                        ...
                        <div class="header__navbar-item header__navbar-user">
                            <img src="https://scontent.fhan14-1.fna.fbcdn.net/v/t1.6435-9/123244758_1232275630487738_8302738713518156827_n.jpg?_nc_cat=105&ccb=1-7&_nc_sid=174925&_nc_ohc=5aaJ6F9Ck2sAX9hZx07&_nc_ht=scontent.fhan14-1.fna&oh=00_AfCN2AXUSt_D5Z-GQpJ-DIUPGS_L71ZZ6_piiH7iPw9XJA&oe=64E606C1" alt="" class="header__navbar-user-img">
                            <span class="header__navbar-user-name">Nguyễn Tâm Phước</span>
                    ...
                    <div class="header__search">
                        <div class="header__search-input-wrap">
                            <form action="" method="GET">
                                <input type="text" class="header__search-input" placeholder="Nhập để tìm kiếm sản phẩm" name="find">
                                ...
                                <ul class="header__cart-list-item">
                                    ...
                                    foreach($cart as $item){
                                        ...
                                        <li class="header__cart-item">
                                            <img src='.$item['thumbnail'].' alt="" class="header__cart-item-img">
                                            
                                            <div class="header__cart-item-info">
                                                <div class="header__cart-item-head">
                                                    <h5 class="header__cart-item-name">'.$item['title'].'</h5>
                                                    <div class="header__cart-item-price-wrap">
                                                        <span class="header__cart-item-price">'.number_format($item['priceCurrent'], 0, '', '.').'đ</span>
                                                        <span class="header__cart-item-multiply">x</span>
                                                        <span class="header__cart-item-qnt">'.$item['num'].'</span>
                                                    </div>
                                                </div>
                        ...
                        <nav class="category">
                            ...
                            <ul class="category-list">
                                ...
                                <li class="category-item">
                                    <a href="#" class="category-item__link">Áo sơ mi</a>
                                </li>
                                <li class="category-item">
                                ...
                                <li class="category-item">
                                    <a href="#" class="category-item__link">Trang sức</a>
                                </li>
                                <li class="category-item">
                                    <a href="#" class="category-item__link">Sweater</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
